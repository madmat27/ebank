    ...
    <body>
        ...
        <div id="container">
            ...
            <div id="style-container">
                ...
                <div id="transfer-mainbox"> 
                    ...
                    <p class="regtitle regtitle-extra">Πληρωμές λογαριασμών</p>
                    
                    <!-- Ξεκινάει το div που περιέχει τη φόρμα για τις πληρωμές: -->
                    <div id="accounts" class="transfer-form">
                        
                        <form name="payment" action="./scripts/dopayment.php" onsubmit="return validateForm()" method="post">
                            ...
                            <table style="width: 100%"> 
                                ...
                                <tr style="height: 35px;">
                                    ...
                                    <td style="text-align: right">
                                        ...
                                        <span class="transfer-labels">Προς Οργανισμό</span>&nbsp;<span class="star">*</span>

                                    </td>

                                    <td style="text-align: left">
                                        
                                        <!-- Στοιχείο επιλογών: περιλαμβάνει όλους τους οργανισμούς που υποστηρίζει την πληρωμή η τράπεζά μας: -->
                                        <select name="paymentorg" required class="transfer-inputs" style="width: 100%">
                                            
                                            <?php
            
                                                // Εύρεση οργανισμών που δέχονται πληρωμές μέσω της τράπεζάς μας 
                                ...
                                <tr style="height: 35px;">
                                    ...
                                    <td style="text-align: right">
                                        ...
                                        <span class="transfer-labels">Κωδικός Πληρωμής</span>&nbsp;<span class="star">*</span>
                                    ...
                                    <td style="text-align: left">
                                        ...
                                        <span class="transfer-inputs">
                                            ...
                                            <input name="info" type="text" placeholder="Εισάγετε τον κωδικό πληρωμής όπως αναγράφεται στο απόκομμα λογαριασμού" maxlength="255" style="width: 100%" required>
                                ...
                                <tr style="height: 35px;">
                                    ...
                                    <td style="text-align: left">
                                        ...
                                        <p><input style="width: 215px; height: 35px;" name="trstion_submit" id="trstion_submit" type="submit" value="ΠΛΗΡΩΜΗ"></p>
        ...
        <script>
            ...
            function validateForm() {
                ...
                /* Δήλωση μεταβλητών */
                var amount = document.forms["payment"]["amount"].value;
                var inputDate = new Date(document.forms["payment"]["tr_date"].value);
                var displayDate = document.forms["payment"]["tr_date"].value;
